	...
	<div class="row">
		...
		<table class="table  table-striped" width="100%">
			...
			<tr>
				...
				<th><div class="form-group">
					<?php echo $this->Form->input('Profile.contact', array('class' => 'form-control', 'placeholder' => 'Contact','lable' => false));?>
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<th><div class="form-group">
					<?php echo $this->Form->input('Profile.total_employees', array('class' => 'form-control', 'placeholder' => 'Total Employees','label' => false));?>
					<?php echo $this->Form->error('Profile.total_employees'); ?>
				</div></th>
				<th>	<div class="form-group">
					<?php echo $this->Form->input('Profile.management', array('class' => 'form-control', 'placeholder' => 'Management','label' => false));?>
					<?php echo $this->Form->error('Profile.management'); ?>
				</div></th>
				<th><div class="form-group">
					<?php echo $this->Form->input('Profile.non_management', array('class' => 'form-control', 'placeholder' => 'Non Management','label' => false));?>
					<?php echo $this->Form->error('Profile.non_management'); ?>
				</div></th>
				<th><div class="form-group">
					<?php echo $this->Form->input('Profile.avg_contract_emp_year', array('class' => 'form-control', 'placeholder' => 'Avg Contract Emp Year','label' => 'Avg. No of Contract Employees per Year','label' => false));?>
		...
		<table class="table table-striped">
			...
			<tr>
				<th><div class="form-group">
					<?php echo $this->Form->input('Profile.no_planned_training', array('class' => 'form-control', 'placeholder' => 'Number of Planned Training','label' => false));?>
					<?php echo $this->Form->error('Profile.no_planned_training'); ?>
				</div></th>
				<th><div class="form-group">
					<?php echo $this->Form->input('Profile.no_unplanned_training', array('class' => 'form-control', 'placeholder' => 'Number of Unplanned Training','label' => false));?>
