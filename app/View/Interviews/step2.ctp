<script type="text/javascript">
 ...
 $(document).ready(function() {
        ...
        $("#add").click(function() {
        	...
        	$('#PlannedTrainingOutsourced', newRow).each(function(i){
            	var newID = 'data[PlannedTraining][' + newRowNum + '][outsourced]';
	            $(this).attr('name',newID);
        	});
...
<div class="plannedTrainings form" id="content">
	...
	<div class="row">
		...
		<div class="col-md-12"> <!-- Here actual Model is different but I renamed create to have this form in same model -->
			<?php echo $this->Form->create('PlannedTraining', array('role' => 'form','url' => array('controller' => 'interviews', 'action' => 'add','2'))); ?>
		 <a  id="add">Add new Row</a></td>
			...
			<tr>
				...
				<th><div class="form-group">
					<?php echo $this->Form->input('outsourced', array('class' => 'form-control', 'placeholder' => 'Outsourced','label' => false,'name'=>'data[PlannedTraining][1][outsourced]'));?>
				</div></th>
				<th><div class="form-group">
				...
				<th><div class="form-group">
					<?php echo $this->Form->input('avg_no_emp_train_year', array('class' => 'form-control', 'placeholder' => 'Avg No Emp Train Year','label' => false,'name'=>'data[PlannedTraining][1][avg_no_emp_train_year]'));?>
				</div></th>
				</tr>
			</table>	
			...
			<div class="row">
		<div class="col-md-10">
			<?php	echo $this->Html->link('Previous step',array('controller'=>'interview_datas','action' => 'add','1'),
